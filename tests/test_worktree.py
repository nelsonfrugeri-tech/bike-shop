...
class TestEnsureWorktree:
    ...
    def test_default_name(self, mock_create: MagicMock, tmp_path) -> None:
        ...
        mock_create.assert_called_once_with("elliot-default", base_branch=None, repo_path=None, worktree_dir=None)
    ...
    def test_with_task_id(self, mock_create: MagicMock, tmp_path) -> None:
        ...
        mock_create.assert_called_once_with("elliot-funds-abc", base_branch=None, repo_path=None, worktree_dir=None)
